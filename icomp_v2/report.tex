...
reference matched in length to the data.} Length matching is not a detail. A Lorenz
attractor of $12\,000$ samples grows by a factor of $1.66$ across the embedding range while
one of $2000$ samples grows by $8.86$, so a reference of the wrong length manufactures a
separation by itself (\cref{fig:dimension}b).
