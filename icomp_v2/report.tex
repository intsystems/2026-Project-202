...
carries three seeds of the grokking condition against three never-generalising runs, two
training fractions with the smaller replicated at a second seed, and the two families do
...
Quantitatively, the runs that never generalise reach $7.26\times10^{-2}$,
$5.49\times10^{-2}$ and $5.30\times10^{-2}$ over the second half of training against
$1.94\times10^{-2}$, $1.84\times10^{-2}$ and $1.38\times10^{-2}$ for the three grokking
runs, a separation of at least a factor of $2.7$ with no overlap. The two seeds of the
same reduced-data condition agree to within $3\%$, so the ordering does not rest on a
single draw. The run without weight decay falls to $1.53\times10^{-4}$. Every run with weight decay lies within a factor of five of every
