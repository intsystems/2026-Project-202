...
def main():
    lines = (ROOT/'report_ru.md').read_text(encoding='utf-8').splitlines()
    title = lines[0][2:]
    body, i = [], 1
    while i < len(lines):
        line = lines[i]
        if line == '$$':
            ...
            body += [r'\begin{center}',
                     r'\includegraphics[width=\linewidth]{overview.pdf}',
                     r'\end{center}']
        else:
...
'''
    ...
    print('Built report_ru.pdf without overflow, missing characters, or LaTeX errors.')
