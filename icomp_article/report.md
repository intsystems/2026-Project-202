...
accuracy exactly constant for 19 000 steps) remain genuine. So every "2 of 3 false alarms"
in this project is **1 confirmed and 1 unresolved**, and specificity here is *unmeasured*
rather than measured and poor. `../dimension_recovery/extend_runs.py` is what settles it.
...
14. **New.** `lowdata15` is a genuine counterexample on the evidence available: 0.03× of
    chance accuracy over its last 2000 steps, 34× *below* guessing, and it never reached
    even 1× chance at any point in 20 000 steps.
